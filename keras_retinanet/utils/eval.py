...
def _compute_coco_ap(precision):
    """ Compute the average precision, given the recall and precision curves.
...
def evaluate(
    ...
    for label in range(generator.num_classes()):
        ...
        if num_annotations == 0:
            ...
            #average_precisions_coco[label] = 0, 0################new
        ...
        #average_precision_coco = _compute_coco_ap(precision)
        average_precisions[label] = average_precision, num_annotations
        #average_precisions_coco[label] = average_precision_coco, num_annotations#####################################################

    # inference time
    inference_time = np.sum(all_inferences) / generator.size()
    return average_precisions, inference_time

    #return average_precisions, inference_time,  average_precisions_coco
