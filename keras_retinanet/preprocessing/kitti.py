...
class KittiGenerator(Generator):
    ...
    def __init__(
        ...
        **kwargs
        ...
        label_dir = 'C:/Users/14590/OneDrive/桌面/Victor/dataset/kitti/training/label_2'
        image_dir = 'C:/Users/14590/OneDrive/桌面/Victor/dataset/kitti/training/image_2'
    ...
    def cal_instances(self):
        """ Load annotations for an image_index.
        """
        ll=len(kitti_classes)
        contents=[0 for index in range(ll-1)]
        ...
        print('class 8 and 9 has '+ str(contents[7]) + ' instances')
        return contents
